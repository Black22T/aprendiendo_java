...
public class ej02preciodelBoleto {
    public static void main(String[] args) {
        ...
        double precio = distancia * 10.5; // Se calcula el precio del boleto multiplicando la distancia por el precio por kilómetro

        System.out.println("El precio del boleto es de: Bs/." + precio); // Se muestra el precio del boleto al usuario
